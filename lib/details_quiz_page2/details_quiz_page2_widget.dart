...
import 'details_quiz_page2_model.dart';
export 'details_quiz_page2_model.dart';

class DetailsQuizPage2Widget extends StatefulWidget {
  const DetailsQuizPage2Widget({super.key});

  @override
  State<DetailsQuizPage2Widget> createState() => _DetailsQuizPage2WidgetState();
}

class _DetailsQuizPage2WidgetState extends State<DetailsQuizPage2Widget>
    with TickerProviderStateMixin {
  late DetailsQuizPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsQuizPage2Model());
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('DetailsQuiz3');
                      },
                      text: 'Next Question',
