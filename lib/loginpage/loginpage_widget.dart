...
class _LoginpageWidgetState extends State<LoginpageWidget>
  ...
  void initState() {
    ...
    _model.nickameTextController ??= TextEditingController();
    _model.nickameFocusNode ??= FocusNode();
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        16.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      'BeWare - Tu Asistente de Apoyo Emocional',
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .nickameTextController,
                                                    focusNode:
                                                        _model.nickameFocusNode,
                                                    autofocus: true,
                                                    autofillHints: const [
                                                    ...
                                                    cursorColor:
                                                        const Color(0xFF4B39EF),
                                                    validator: _model
                                                        .nickameTextControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
